...
knowledge2 = And(
    And(Biconditional(AKnight, Not(AKnave)), Biconditional(BKnight, Not(BKnave))), And(Implication(Or(And(AKnight, BKnight)), And(AKnave, BKnave)), AKnight), (Implication(Or(And(AKnight, BKnave)), And(AKnave, BKnight)), BKnight)
    )
