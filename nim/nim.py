...
class NimAI():
    ...
    def update(self, old_state, action, new_state, reward):
        ...
        Q value is the cost of taking an action
        """
    ...
    def best_future_reward(self, state):
        ...
        `state`, return 0.
        """
        # maybe i need to go deeper and take all the actions
    ...
    def choose_action(self, state, epsilon=True):
        ...
        # cant i just use the best furture award? its kinda the same

        # maybe create a fucntion that creates all actions? it could also maybe store them?
        actions = set()
        for i, pile in enumerate(state):
            for j in range(1, pile + 1):
                actions.add((i, j))
        ...
        if not epsilon:
            ...
            # the rare case when choose random
